...
* Дождитесь проверки. При наличии замечаний, исправьте их и повторите процесс. При этом изменения обязательно должны быть разбиты на отдельные коммиты, в соответствии с замечаниями (или группами тесно связанных замечаний), а не объединены все в одну "кучу".
